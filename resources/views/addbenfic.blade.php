...
<div class="bg-[#050621]">
    ...
    <p class=" mt-4  text-white ml-8">add > <span class="font-bold">benficary</span></p>
        ...
        <div class="mt-10 sm:mt-10 mb-20">
            <div class=" md:gap-6 ">
              <div class="mt-5  md:mt-0">
                <form action="{{route('savebenfic')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="bg-white px-4 py-5 sm:p-6 ">
                      <div class="grid grid-cols-10 gap-4">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                          ...
                          <input type="text" name="cardto"  class="bg-gray-200 h-10 w-96 mt-4 block  rounded-md  border-black shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          @error('cardto')
                          <small class="form-text text-danger"> {{$message}} </small>
                          @enderror
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text"  name="amount"  class="bg-gray-200 h-10 w-96 mt-4 block  rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            @error('amount')
                            <small class="form-text text-danger"> {{$message}} </small>
                            @enderror
                        </div>
                          ...
                          <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="phone"  class="bg-gray-200 h-10 w-96 mt-4 block  rounded-md  border-black shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            @error('phone')
                            <small class="form-text text-danger"> {{$message}} </small>
                            @enderror
                        </div>
